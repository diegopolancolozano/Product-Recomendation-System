...
output "subnet_name"       { value = google_compute_subnetwork.private.name }
output "vpc_connection_id" { value = google_service_networking_connection.private_vpc_connection.id }
